...
from config import (DEVICE, SEVERITY_LEVELS, WOUND_TYPE_CLASSES,
...
class ClassificationModel(nn.Module):
    ...
    def __init__(
        ...
        self.num_severity_levels = (
            num_severity_levels or classification_config.num_severity_levels
        )
...
class WoundClassifier:
    ...
    def classify(self, image: np.ndarray) -> ClassificationResult:
        ...
        return ClassificationResult(
            ...
            wound_type_confidence=float(wound_probs[wound_type_id]),
...
def get_gradcam(
    self, image: np.ndarray, task: str = "wound_type"
