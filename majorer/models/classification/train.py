...
from config import (DEVICE, FOLDER_TO_CLASS, OUTPUT_DIR, UNIFIED_DIR,
                    WOUND_TYPE_CLASSES, classification_config, training_config)
...
class WoundClassificationDataset(Dataset):
    ...
    def __init__(self, data_dir: Path, split: str = "train", transform=None):
        ...
        self.severity_to_idx = {"mild": 0, "moderate": 1, "severe": 2, "critical": 3}
...
class ClassificationTrainer:
    ...
    def setup(self):
        ...
        # Loss
        self.criterion = MultiTaskLoss(wound_weight=1.0, severity_weight=0.5)
    ...
    def train_epoch(self, dataloader: DataLoader) -> float:
        ...
        for batch in pbar:
            ...
            loss, loss_dict = self.criterion(
                wound_logits, severity_logits, wound_types, severities
            )
