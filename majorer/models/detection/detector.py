...
from config import DEVICE, yolo_config
...
class WoundDetector:
    ...
    def detect(
        self, image: Union[np.ndarray, str, Path], return_all: bool = False
    ...
    def draw_detections(
        ...
        for det in detections:
            ...
            cv2.putText(
                output, label, (x1, y1 - 5), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 0), 1
            )

        return output

    def process_batch(
        self, images: List[Union[np.ndarray, str, Path]]
