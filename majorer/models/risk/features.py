...
class FeatureExtractor:
    ...
    def extract(
        ...
        volume_result: Optional[object] = None,
    ) -> WoundFeatures:
        """
        ...
        # Geometric features
        wound_area, wound_perimeter, circularity = self._compute_geometry(
            segmentation_mask
        )
    ...
    def extract_temporal_features(
        ...
        previous_features: Optional[WoundFeatures] = None,
    ) -> Dict:
        """
        ...
        return {
            ...
            "volume_change": current_features.total_volume
            - previous_features.total_volume,
            "healthy_ratio_change": current_features.healthy_ratio
            - previous_features.healthy_ratio,
            "necrotic_burden_change": current_features.necrotic_burden
            - previous_features.necrotic_burden,
        }
